            ...
            <div class="container">
                ...
                <div class="tab-content" id="pills-tabContent">
                    ...
                    <div class="tab-pane fade show active" id="pills-datos" role="tabpanel" aria-labelledby="pills-1" tabindex="0">
                        ...
                        <div class="row g-3 mb-3 align-items-center">
                            <label for="selectTema" class="offset-xxl-2 col-xxl-2 col-sm-3  col-form-label text-sm-end text-start">Tema o área de la ponencia:</label>
                            <div class="col-xxl-4 col-sm-6">
                    ...
                    <div class="tab-pane fade" id="pills-archivo" role="tabpanel" aria-labelledby="pills-2" tabindex="0">
                        ...
                        <div class="row g-3 mb-3 mt-4 align-items-center">
                            <div class="text-center">
                                <button type="button" id="btnGuardar" class="btn btn-secondary btn-block w-auto">Enviar</button>
                            </div>
                        </div>
                    </div>
                            ...
                            <div class="modal-dialog modal-lg">
                                <div class="modal-content">
                                    ...
                                    <div class="modal-body">
                                        ...
                                        <div class="row mb-3 g-3 align-items-center">
                                            <label for="txtIns" class="offset-xxl-1 col-xxl-3 col-sm-3  col-form-label text-sm-end text-start">Estado de la institución:</label>
                                            <div class="col-xxl-4 col-sm-6">
                                        ...
                                        <div class="row mb-3 g-3 align-items-center">
                                            <label for="txtIns" class="offset-xxl-1 col-xxl-3 col-sm-3  col-form-label text-sm-end text-start">Institución del autor:</label>
                                            <div class="col-xxl-4 col-sm-6">
                                                <%-- <input type="text" id="txtIns" class="form-control" required="required"/> --%>
